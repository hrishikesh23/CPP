/* Lecture Code 9.1
 *
 * The full DebugVector template class, including deep-copying support.
 * Comments have been added to the relevant sections.  Note that this
 * DebugVector does not have an assignment operator, so you will run
 * into trouble if you try to assign DebugVectors to one another.
 */
...
public:
	...
	/* Assignment operator will go here. */
...
int main()
{
DebugVector <int> obj1;
DebugVector <int> obj2 = obj1;
